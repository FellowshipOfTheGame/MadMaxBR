...
public class VehicleControl : MonoBehaviour
{
    ...
    public class CarSetting
    {
        ...
        public float springs = 25000.0f; // Spring rate
        public float dampers = 1500.0f; // Dampers rate

        public float carPower = 120f; // power of moving car
        public float shiftPower = 150f; // power of braking
    ...
    : slip = Mathf.Lerp(slip, 0.01f, 0.02f);
            ...
            if (shift && (currentGear > 1 && speed > 50.0f) && shifmotor && Mathf.Abs(steer) < 0.2f)
            {
                ...
                //carParticles.shiftParticle1.emission.rateOverTime.constantMax = Mathf.Lerp(emissionRateShiftParticle1.constantMax, powerShift > 0 ? 50 : 0, Time.deltaTime * 10.0f);
                //emissionRateShiftParticle1.constantMax = Mathf.Lerp(emissionRateShiftParticle1.constantMax, powerShift > 0 ? 50 : 0, Time.deltaTime * 10.0f);
